...
//                teacherLoginDB.addIPToUsersDB(Util.getIPAddress(), id);
//                teacherLoginDB.setLoggedIn(true);
//
//                Student data = teacherLoginDB.getStudentByID(id);
//                data.setClassData(teacherLoginDB.getClassData(data));
//                setData(data);
//                teacherFrame.getAvgMarkCounter().count(id);
